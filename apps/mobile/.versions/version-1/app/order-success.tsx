    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          {hasCustomOrders ? (
            <View style={[styles.customOrdersSection, hasProducts && { marginTop: 16, paddingTop: 16, borderTopWidth: 1, borderTopColor: '#f3f4f6' }]}>
          ...
          {isCustomOrderOnly ? (
            <View style={styles.customOnlyNote}>
              <Text style={styles.customOnlyNoteText}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity 
          ...
          onPress={() => router.push(`/track-order?orderId=${orderId}`)}
        >
