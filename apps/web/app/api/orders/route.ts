...
export async function POST(request: NextRequest) {
  try {
    ...
    const businessResult = await sql`
      SELECT commission_rate, name, user_id, email, business_notifications_consent
      FROM businesses 
      WHERE id = ${businessId}
    `;
      ...
      if (userId) {
        ...
        await sql`
          INSERT INTO notifications (
            ...
            ${`Your order ${orderNumber} has been placed at ${business.name}. You'll receive updates as it's processed.`},
            ${'order'},
            ${orderId}
          )
        `;
                ...
                <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
                  ...
                  <div style="padding: 32px 20px;">
                    ...
                    <div style="text-align: center; margin-bottom: 24px;">
                      ...
                      <p style="color: #111827; font-size: 18px; font-weight: 600; margin: 4px 0 0 0;">${business.name}</p>
                    </div>
            ...
            html: `
              ...
              <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; background: #f9fafb;">
                <div style="max-width: 600px; margin: 0 auto; background: #ffffff;">
                  ...
                  <!-- Content -->
                  <div style="padding: 32px 20px;">
                    <p style="color: #111827; font-size: 16px; margin: 0 0 24px 0;">Hi ${business.name},</p>
